...
#define ENDRADIUS 150.0f
#define FARRADIUS 170.0f
#define STARTPOINT CGPointMake(90, 295)
...
//                                           ContentImage:[UIImage imageNamed:@"icon-main.png"] 
//                                highlightedContentImage:[UIImage imageNamed:@"icon-main-highlighted.png"]];

        _addButton = [[QuadCurveMenuItem alloc] initWithImage:[UIImage imageNamed:@"icon_5.png"]
...
- (void)_expand
{
    ...
    rotateAnimation.values = [NSArray arrayWithObjects:[NSNumber numberWithFloat:M_PI_4 * 7],[NSNumber numberWithFloat:M_PI_4 * 7], nil];
    ...
    item.transform = CGAffineTransformMakeRotation(M_PI_4 * 7);
