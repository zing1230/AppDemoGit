...
- (void)setup {
	...
	self.minimumTrackTintColor = [UIColor colorWithRed:245.0/255.0 green:48/255.0 blue:63/255.0 alpha:1];
	self.maximumTrackTintColor = [UIColor clearColor];
	self.thumbTintColor = [UIColor colorWithRed:245.0/255.0 green:48/255.0 blue:63/255.0 alpha:1];
	self.continuous = YES;
